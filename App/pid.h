...
#define PID_ROLL_KP  40
#define PID_ROLL_KI  0
#define PID_ROLL_KD  0.0
#define PID_ROLL_INTEGRATION_LIMIT    2.0

#define PID_PITCH_KP  40
#define PID_PITCH_KI  0.0
#define PID_PITCH_KD  0.0
#define PID_PITCH_INTEGRATION_LIMIT   2.0
