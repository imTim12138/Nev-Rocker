...
//		yawRateDesired = Motor_Rud;
	...
	controllerCorrectRatePID(mpu_info.gyro.y* Gyro2Degree, mpu_info.gyro.x* Gyro2Degree, mpu_info.gyro.z* Gyro2Degree,  //改动
...
void Getdesireddata(u8 *buf)
{
	...
	Motor_Ele=Motor_Ele/60.0;				//转化单位为角度-25~25度
	Motor_Ail=Motor_Ail/60.0;
	ch2 /=30;
	if(ch2*ch2<25)
		ch2=0;
	rud_sum += (ch2/10.0);  //
